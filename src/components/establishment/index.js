  ...
  return (
    <LeftBar>
      ...
      (establishment.photos) ?
         <Image src={`
           https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${establishment.photos[0].photo_reference}&key=${REACT_APP_GOOGLE_API_KEY}`} alt="Store perfil"
         />
        :
      ...
      <Title>{establishment.name}</Title>
      {
        (establishment.opening_hours) ?
          ...
          : "Não há cadastro de dias e horários de funcionamento!"
      }
      <hr/>
